...
##使用说明
*   根目录配置到thinkphp-travel/public/下
*   新建一个数据库travel,将thinkphp-travel/data/travel.sql导入到数据库中
*   修改thinkphp-travel/application/database.php的配置，默认数据库账号：root,密码:root,数据库：travel
