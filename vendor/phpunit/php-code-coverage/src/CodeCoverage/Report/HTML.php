...
class PHP_CodeCoverage_Report_HTML
{
    ...
    {
        $dir = $this->getDirectory($target . 'imgareaselect');
        copy($this->templatePath . 'imgareaselect/bootstrap.min.imgareaselect', $dir . 'bootstrap.min.imgareaselect');
        copy($this->templatePath . 'imgareaselect/nv.d3.min.imgareaselect', $dir . 'nv.d3.min.imgareaselect');
        copy($this->templatePath . 'imgareaselect/style.imgareaselect', $dir . 'style.imgareaselect');
