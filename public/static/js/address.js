 ...
 */
//省、市、区
var region_init = function (_region_p, _region_c, _region_d) {
    var region_p = $('select[id="'+ _region_p +'"]').get(0);
    var region_c = $('select[id="'+ _region_c +'"]').get(0);
    var region_d = $('select[id="'+ _region_d +'"]').get(0);
    var _region_p_default = $('select[id="'+ _region_p +'"]').attr("data-default");
    var _region_c_default = $('select[id="'+ _region_c +'"]').attr("data-default");
    var _region_d_default = $('select[id="'+ _region_d +'"]').attr("data-default");
